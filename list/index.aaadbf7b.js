...
o.sort((t,e)=>t.length-e.length||t.localeCompare(e)),o.forEach(function(o){let i=document.createElement("div");i.id=o,i.className="noselect child shadow",i.textContent=`${t} ${o}`,i.addEventListener("click",()=>(function(n){let o=document.getElementById(n);o.textContent.startsWith(t)?o.textContent=`${e} ${n}`:o.textContent=`${t} ${n}`})(o)),n.appendChild(i)});//# sourceMappingURL=index.aaadbf7b.js.map

//# sourceMappingURL=index.aaadbf7b.js.map
