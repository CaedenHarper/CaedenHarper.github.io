 ...
 */ parcelHelpers.export(exports, "print_stats", ()=>print_stats);
...
function print_stats(times, average_list, graph_min, graph_max, solve_nums, step, streaks, ignore_dnf, ignore_plus_two) {
    if (times.length < 1) {
...
function draw_screen(time_input) {
    ...
    print_stats(time_input, average_list, graph_min, graph_max, solve_nums, step, streak_list, ignore_dnf, ignore_plus_two);
}
function main() {
    let time_input;
