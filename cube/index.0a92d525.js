...
})({"9n0if":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c76a21c30a92d525";
"use strict";
 ...
 * @param {Number[]} streaks - Numbers to show a best streak of.
 * @returns {void}
 */ function print_stats(times, average_list, graph_min, graph_max, solve_nums, step, streaks) {
    ...
    for(let index = 0; index < times.length; index += 1){
        ...
        for(let i = 0; i < average_keys.length; i += 1){
            ...
            if (index > key - 1) {
                const sub_times = [];
                for(let n = index - (key - 1); n < index + 1; n += 1)sub_times.push(times[n]);
                const avg = average_of_n(sub_times);
                if (!avg.getDNF) average_dict[key].push(avg);
            }
        }
...
function draw_screen(time_input) {
    ...
    print_stats(time_input, average_list, graph_min, graph_max, solve_nums, step, streak_list);
}
function main() {
    let time_input;
...
},{}]},["9n0if","dacnS"], "dacnS", "parcelRequire4353")
