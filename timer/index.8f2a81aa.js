...
u=Math.floor((i=t-n)/864e5),a=Math.floor(i%864e5/36e5),c=Math.floor(i%36e5/6e4),h=Math.floor(i%6e4/1e3),i<0?e.textContent=o:c<=0&&a<=0&&u<=0?e.textContent=`${h}s `:a<=0&&u<=0?e.textContent=`${c}m ${h}s`:u<=0?e.textContent=`${a}h ${c}m ${h}s`:e.textContent=`${u}d ${a}h ${c}m ${h}s`,x()},1e3);//# sourceMappingURL=index.8f2a81aa.js.map

//# sourceMappingURL=index.8f2a81aa.js.map
