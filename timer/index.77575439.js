...
u=Math.floor((r=t-n)/864e5),a=Math.floor(r%864e5/36e5),c=Math.floor(r%36e5/6e4),l=Math.floor(r%6e4/1e3),r<0?e.textContent=o:c<=0&&a<=0&&u<=0?e.textContent=`${l}s `:a<=0&&u<=0?e.textContent=`${c}m ${l}s`:u<=0?e.textContent=`${a}h ${c}m ${l}s`:e.textContent=`${u}d ${a}h ${c}m ${l}s`,x()},1e3);//# sourceMappingURL=index.77575439.js.map

//# sourceMappingURL=index.77575439.js.map
