...
i=Math.floor((u=t-n)/864e5),a=Math.floor(u%864e5/36e5),c=Math.floor(u%36e5/6e4),h=Math.floor(u%6e4/1e3),u<0?e.textContent=o:c<=0&&a<=0&&i<=0?e.textContent=`${h}s `:a<=0&&i<=0?e.textContent=`${c}m ${h}s`:i<=0?e.textContent=`${a}h ${c}m ${h}s`:e.textContent=`${i}d ${a}h ${c}m ${h}s`,d()},1e3);//# sourceMappingURL=index.db74d162.js.map

//# sourceMappingURL=index.db74d162.js.map
